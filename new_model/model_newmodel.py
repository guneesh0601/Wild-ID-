...
class WildIDClassifier(nn.Module):
    def __init__(self, num_classes=10127): 
        ...
        # 2. CNN Blocks (Dropout INCREASED to 0.3)
        self.block1 = nn.Sequential(
            nn.Conv2d(1, 64, kernel_size=5, padding=2), 
            nn.BatchNorm2d(64),                         
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=(2, 1)),           
            nn.Dropout(0.3)  # <--- Increased to 0.3
        )
        ...
        # 4. Classifier (Deep: 4 Layers with 0.5 Dropout)
        # Input size is 128*2 = 256 because of bidirectional LSTM
